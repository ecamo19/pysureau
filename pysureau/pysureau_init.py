# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/06_pysureau_init.ipynb.

# %% auto 0
__all__ = ['pysureau_init']

# %% ../nbs/06_pysureau_init.ipynb 3
import os
import csv
import shortuuid
...
def pysureau_init(
    ...
    if path is None:
        ...
        # Create parameter definitions file
        _create_parameter_definitions_csv_file(path = path_to_params_folder, 
