# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/04_pysureau_utils.ipynb.

# %% auto 0
__all__ = ['pysureau_init', 'dict_to_csv']

# %% ../nbs/04_pysureau_utils.ipynb 3
import os
import csv
import shortuuid
...
# %% ../nbs/04_pysureau_utils.ipynb 5
def dict_to_csv(dictionary: Dict, # Dictionary 
